...
{{-- NOTE: page dashboard categories -> contenu injecté dans le layout --}}

@section('title', 'Catégories — Dashboard')

@section('content')

<!-- Contenu ancien (template HTML) conservé : la structure HTML globale est fournie par resources/views/dashboard.blade.php -->
