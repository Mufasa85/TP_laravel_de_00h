...
@section('content')
    <section class="hero">
        ...
        <div class="hero-visual">
            ...
            <div class="stack-card">
                ...
                <div class="card-excerpt-sm" style="color:#8C7B6B">
    ...
    <section class="section" style="padding-bottom:0">
        ...
        <div class="categories-row">
            {{-- Lien fictif “actif” : on garde une UI statique ici (pas de données en DB demandées) --}}
    ...
    <section class="section">
        ...
        <div class="articles-grid">
            {{-- Cartes d'articles : lien vers le détail via slug route --}}
            <a href="{{ route('articles.show', ['slug' => 'excepturi-eligendi-art-1']) }}" class="article-card featured">
                <div class="article-cat">Vitae • À la une</div>
                <h2 class="article-title">Excepturi eligendi aliquid iste laboriosam</h2>
                <p class="article-excerpt">Recusandae non totam rerum vero at. Vel ut soluta ipsum nihil aut natus
                    ...
                    Excepturi consequuntur et voluptatem adipisci doloribus et.</p>
            ...
            <a href="{{ route('articles.show', ['slug' => 'aut-repellat-art-2']) }}" class="article-card">
                <div class="article-cat">Aperiam</div>
                <h3 class="article-title">Aut repellat ut qui et</h3>
                <p class="article-excerpt">Pariatur nobis dicta esse cum. Magni nesciunt facere exercitationem.
                    Dolorum est facilis quia voluptatum architecto in quibusdam ex unde enim.</p>
                <div class="article-meta">
            ...
            <a href="{{ route('articles.show', ['slug' => 'dignissimos-art-3']) }}" class="article-card">
                <div class="article-cat">Optio</div>
                <h3 class="article-title">Dignissimos et eaque aut sed fugiat et</h3>
                <p class="article-excerpt">Voluptas quod nihil voluptatum animi voluptates mollitia sed.
                    Perspiciatis blanditiis libero earum quod eos omnis. Placeat nesciunt ut ut eos.</p>
                <div class="article-meta">
